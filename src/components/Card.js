...
function Card({ card, handleCardClick, onCardLike, handleOpenPopupDelete, setDeleteId }) {
    ...
    return(
        <li className="pictures__picture picture" >
          {isOwn ? <button className="pictures__trash" onClick={handleDeleteClick} type="button"/> : null}
